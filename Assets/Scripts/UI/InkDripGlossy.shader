Shader "UI/InkDripGlossy"
{
    Properties
    {
        [PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
        _Color ("Tint", Color) = (0,0,0,0.9)
        _Glossiness ("Glossiness", Range(0,1)) = 0.8
        _SpecularPower ("Specular Power", Range(1,50)) = 20
